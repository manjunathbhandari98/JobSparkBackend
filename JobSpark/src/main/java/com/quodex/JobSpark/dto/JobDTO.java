...
public class JobDTO {
    ...
    public JobDTO(
            Long id, String jobTitle,
            String company, List<ApplicantDTO> applicants,
            String about, String experience, String jobType,
            String location, String packageOffered,
            LocalDateTime postTime, String description,
